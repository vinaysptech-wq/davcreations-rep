...
import { profileApi } from "../../shared/utils/apiClient";
          ...
          <div className="mb-6">
            <div className="flex items-center gap-4">
              <div className="relative">
                <Image
                  src={profile.image ? `${process.env.NEXT_PUBLIC_API_URL}${profile.image}` : '/images/user/user-01.jpg'}
                  alt="Profile"
                  width={80}
                  height={80}
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {uploading ? 'Uploading...' : 'Click the icon to change your profile picture'}
                </p>
              </div>
            </div>
          </div>
